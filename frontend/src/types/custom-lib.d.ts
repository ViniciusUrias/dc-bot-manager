import { Equatable, JSONEncodable } from "@discordjs/util";
...
declare function validateRequiredSelectMenuParameters(
...
declare function validateRequiredButtonParameters(
	style?: ButtonStyle,
	label?: string,
 ...
 */
declare abstract class BaseSelectMenuBuilder<
 ...
 */
declare class ActionRowBuilder<ComponentType extends AnyComponentBuilder> extends ComponentBuilder<
 ...
 */
declare function createComponentBuilder<ComponentType extends keyof MappedComponentTypes>(
	data: (APIModalComponent | APIMessageComponent) & {
		type: ComponentType;
	}
 ...
 * @param data - The API data to transform to a component class
 */
declare function createComponentBuilder<ComponentBuilder extends MessageComponentBuilder | ModalComponentBuilder>(
...
declare const componentsValidator: _sapphire_shapeshift.ArrayValidator<
	[ActionRowBuilder<AnyComponentBuilder>, ...ActionRowBuilder<AnyComponentBuilder>[]],
	ActionRowBuilder<AnyComponentBuilder>
>;
declare function validateRequiredParameters$2(
	customId?: string,
	title?: string,
 ...
 */
declare class SlashCommandIntegerOption
 ...
 */
declare class SlashCommandNumberOption
	extends ApplicationCommandOptionBase
	implements ApplicationCommandNumericOptionMinMaxValueMixin
{
	/**
...
declare function validateRequiredParameters$1(
	name: string,
	description: string,
...
declare function assertReturnOfBuilder<
...
declare const localizationMapPredicate: _sapphire_shapeshift.UnionValidator<
	_sapphire_shapeshift.UndefinedToOptional<Partial<Record<Locale, string | null>>> | null | undefined
>;
...
declare namespace Assertions$1 {
	export {
		...
		contextsPredicate$1 as contextsPredicate,
		integrationTypesPredicate$1 as integrationTypesPredicate,
...
declare namespace Assertions {
	export {
		Assertions_contextsPredicate as contextsPredicate,
		Assertions_integrationTypesPredicate as integrationTypesPredicate,
...
export {
	...
	ButtonBuilder,
	ChannelSelectMenuBuilder,
	Assertions$4 as ComponentAssertions,
	ComponentBuilder,
	Assertions as ContextMenuCommandAssertions,
	ContextMenuCommandBuilder,
	createComponentBuilder,
	disableValidators,
	Assertions$5 as EmbedAssertions,
	EmbedBuilder,
	embedLength,
	enableValidators,
	isValidationEnabled,
	MentionableSelectMenuBuilder,
	Assertions$2 as ModalAssertions,
	ModalBuilder,
	normalizeArray,
	RoleSelectMenuBuilder,
	...
	Assertions$1 as SlashCommandAssertions,
	...
	StringSelectMenuBuilder,
	StringSelectMenuOptionBuilder,
	Assertions$3 as TextInputAssertions,
	TextInputBuilder,
	UserSelectMenuBuilder,
	version,
